...
<form method = "post" action="<%=request.getContextPath()%>/updateCandidateDetails?id=${id}" name = "myform" onsubmit="return validate();">
 ...
 <table>
   ...
   <tr>
   <td> Skills </td>
   <td> <input type = "text" name="txt_skills" value=${skills}></td>
   </tr>
   
    <tr>
   <td> <input type="submit" name="btn_add" Value="Update">
    ${message}
